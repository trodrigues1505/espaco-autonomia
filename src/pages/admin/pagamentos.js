  ...
  container.innerHTML = `
    ...
    <div class="content">
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:16px">
        <div onclick="window._pgFiltro='RECEIVED';navigate('pagamentos')" style="background:#fff;border:1px solid var(--borda);border-radius:var(--r);padding:14px 16px;border-top:3px solid #1a5a1a;cursor:pointer" title="Ver recebidos">
          ...
          <div style="height:4px;background:#e8f4e8;border-radius:2px;margin:8px 0 6px">
            <div style="height:4px;background:#1a5a1a;border-radius:2px;width:${pgsMes.length?Math.round(recebidos.length/pgsMes.length*100):0}%"></div>
          </div>
          <div style="font-size:10px;color:var(--txt2)">${recebidos.length} cobranças · clique para ver ↓</div>
        </div>
        <div onclick="window._pgFiltro='PENDING';navigate('pagamentos')" style="background:#fff;border:1px solid var(--borda);border-radius:var(--r);padding:14px 16px;border-top:3px solid #e67e22;cursor:pointer" title="Ver aguardando">
          ...
          <div style="height:4px;background:rgba(232,188,79,.2);border-radius:2px;margin:8px 0 6px">
            <div style="height:4px;background:#e67e22;border-radius:2px;width:${pgsMes.length?Math.round(aguardando.length/pgsMes.length*100):0}%"></div>
          </div>
          <div style="font-size:10px;color:var(--txt2)">${aguardando.length} cobranças · clique para ver ↓</div>
        </div>
        <div onclick="window._pgFiltro='OVERDUE';navigate('pagamentos')" style="background:#fff;border:1px solid var(--borda);border-radius:var(--r);padding:14px 16px;border-top:3px solid #c0392b;cursor:pointer" title="Ver vencidos">
          ...
          <div style="height:4px;background:#fceaea;border-radius:2px;margin:8px 0 6px">
            <div style="height:4px;background:#c0392b;border-radius:2px;width:${pgsMes.length?Math.round(vencidos.length/pgsMes.length*100):0}%"></div>
          </div>
