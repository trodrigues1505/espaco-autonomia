 ...
 * Responsabilidade: Grade de aulas do aluno — confirmar/cancelar presença.
...
export async function renderGrade(container) {
  ...
  if (page === 'grade' || page === 'aluno-grade') {
    ...
    // Navegação de semana
    const navHtml = `<div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;flex-wrap:wrap">
      ...
      ${!isAluno?`<div style="margin-left:auto;display:flex;gap:6px">
